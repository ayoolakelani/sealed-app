...
export class CacService {
  ...
  constructor(private afs: AngularFirestore, private auth: AuthService) {
   ...
   CreateRequest(request : CacRequest) : boolean
   {
    ...
    var response =  this.afs.collection( this.basePath).doc(request.userId).collection("applications").doc(request.requestId).set({...request});
   ...
   {
     var CacRequestRef =  userId ?this.afs.collection(this.basePath).doc(userId).collection("applications") : this.afs.collection(this.basePath);
